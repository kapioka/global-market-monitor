...
def build_sample_prices(length: int = 520) -> pd.DataFrame:
    ...
    specs = {
        ...
        "^VIX": SyntheticSpec(seed=34, drift=0.00015, volatility=0.045),
        "^MOVE": SyntheticSpec(seed=35, drift=0.00012, volatility=0.03),
        "CL=F": SyntheticSpec(seed=23, drift=0.00065, volatility=0.04),
        "BZ=F": SyntheticSpec(seed=36, drift=0.00062, volatility=0.038),
